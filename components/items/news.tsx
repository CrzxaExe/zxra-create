...
const News = () => {
  return (
    <div className="w-full overflow-hidden mt-3 md:-mt-2 lg:-mt-[5.4rem] mb-7 relative flex md:flex-row transition-all duration-300 ease-in-out">
      ...
      />
      <div className="absolute md:relative -left-4 top-0 px-4 w-full h-full md:ml-4 md:bg-[#262c3a]/[0.7] md:backdrop-blur-sm md:h-[32vw] md:max-h-[250px] lg:max-h-[200px]">
        <h1 className="inline ml-2 md:ml-0 px-2 py-1 font-paprika text-base md:text-lg xl:text-xl border-0 border-b-[1px] md:border-b-0 sm:rounded-tl-sm font-bold">
        ...
        <p className="block bg-slate-400/[0.2] md:bg-slate-400/[0] text-xs lg:text-sm absolute w-full md:relative bottom-0 rounded-b-lg py-1 overflow-hidden md:whitespace-normal md:mt-3 px-3 pb-12 md:pb-6 lg:pb-[5rem] pr-4 md:pr-0 md:px-0 h-auto max-h-[44px] md:max-h-[100vh] text-justify md:mb-[3.6rem]">
