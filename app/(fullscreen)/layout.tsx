      ...
      <main className="relative mx-auto flex flex-row">
        <div className="flex flex-col gap-3 bg-[#1d1d1d] w-[10%] sm:w-[7%] lg:w-[16%] min-h-screen px-3 py-6 text-slate-400 overflow-hidden">
          <Link href="/" className="flex flex-col w-full px-[6%]">
            <h1 className="text-xl lg:text-2xl font-valorant hidden lg:block">
              Create Zx
            </h1>
            <Image
              src={logo}
            ...
            />
            <span className="text-sm font-mono hidden lg:block">Apps</span>
          </Link>
          <RightHr text="< Route" className="text-sm" />

          <h1 className="mt-1 text-base px-3 hidden lg:block">Menu</h1>

          <ul className="self-center lg:self-auto">
            <li className="w-full rounded-r-lg text-base transition-all duration-300 ease-in-out lg:hover:bg-base-upfloor">
              <Link
                href="/dashboard"
